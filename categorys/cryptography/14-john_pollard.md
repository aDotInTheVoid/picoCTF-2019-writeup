...
-----END CERTIFICATE-----
```
Using an [online certificate decode](https://certlogik.com/decoder/) we get
```
Certificate:
    Data:
        Version: 1 (0x0)
    ...
    Signature Algorithm: md2WithRSAEncryption
         ...
         25:9a:fd:5f
```
The modulus (n) looks very small. Using [the same factor website](https://www.alpertron.com.ar/ECM.HTM), we get `67867967 × 73176001`
