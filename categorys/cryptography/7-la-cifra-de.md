...
```
Based on the dates, you can guess it is a [Vigenère cipher](https://en.wikipedia.org/wiki/Vigen%C3%A8re_cipher), also knows at times as le chiffre indéchiffrable. Desipte this it is easy enought to crack throuch
[clever frequency analisis](https://en.wikipedia.org/wiki/Kasiski_examination). 

[This website](https://www.guballa.de/vigenere-solver) will do it for you, although it's a fun exercise. 
